package com.example.sys.rideleft.Adapter;
...
public class EventListRecylerView extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
*/
    ...
    public EventListRecylerView(String Titles[], int Icons[], String Name, int Profile){ // EventListRecylerView Constructor with titles and icons parameter
    ...
    /*@Override
    public void onBindViewHolder(EventListRecylerView.ViewHolder holder, int position) {
